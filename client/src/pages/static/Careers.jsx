        ...
        <div className="max-w-4xl mx-auto mb-12 md:mb-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            <div className="text-center bg-white rounded-xl p-4 md:p-6 shadow-sm">
              <div className="text-2xl md:text-3xl font-bold text-slate-800 mb-1">6</div>
              <div className="text-xs md:text-sm text-slate-600">Open Positions</div>
            </div>
            <div className="text-center bg-white rounded-xl p-4 md:p-6 shadow-sm">
              <div className="text-2xl md:text-3xl font-bold text-slate-800 mb-1">100+</div>
              <div className="text-xs md:text-sm text-slate-600">Properties Handled</div>
            </div>
            <div className="text-center bg-white rounded-xl p-4 md:p-6 shadow-sm">
              <div className="text-2xl md:text-3xl font-bold text-slate-800 mb-1">50+</div>
              <div className="text-xs md:text-sm text-slate-600">Happy Clients</div>
            </div>
            <div className="text-center bg-white rounded-xl p-4 md:p-6 shadow-sm">
              <div className="text-2xl md:text-3xl font-bold text-slate-800 mb-1">24/7</div>
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4 md:mb-6">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    <span className={`px-2 md:px-3 py-1 rounded-full text-xs md:text-sm font-medium ${getTypeColor(job.type)}`}>
                      {job.type}
                    </span>
                ...
                {/* Apply Button */}
                <button className="mt-4 md:mt-6 w-full bg-slate-800 hover:bg-slate-900 text-white font-medium py-2 md:py-3 px-4 md:px-6 rounded-lg transition-all duration-300 opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0">
                  Apply Now
                </button>
              </div>
            ))}
        ...
        <div className="text-center mt-16 md:mt-24 bg-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto shadow-lg">
          ...
          <div className="space-y-4 md:space-y-6 text-slate-600">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 mt-6 md:mt-8">
              ...
              <p className="text-sm sm:text-base md:text-lg">
                For queries: 
                <span className="font-semibold text-slate-800 ml-2">+91 9311747466</span>
              </p>
            </div>
          </div>

          <div className="mt-8 md:mt-10 text-xs md:text-sm text-slate-500 italic">
            We review applications within 48 hours and get back to shortlisted candidates quickly.
          </div>
        </div>
      </section>
      <Footer />
